...
Note that some of these notebooks need the bleeding edge version of OWSLib_ (>=0.20.0) and Birdy_ (> 0.6.9) since some issues were found and fixed in the process of writing these notebooks.
