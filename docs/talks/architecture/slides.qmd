---
pagetitle: "Rook federation architecture for ESGF-NG"
fig-responsive: true
keep-md: true
format:
  revealjs:
...
# Rook Federation for ESGF-NG (diagram) {.architecture-diagram}
...
# Rook capabilities (diagram) {.architecture-diagram}
...
# Rook for Copernicus CDS (diagram) {.architecture-diagram}
...
# Processing only when needed (diagram) {.architecture-diagram}
...
# Example: Rook from a notebook (example) {.architecture-diagram}
...
# Example: Rook from a notebook (diagram) {.architecture-diagram}
...
# From CDS to ESGF-NG (diagram) {.architecture-diagram}

## Independently managed ESGF-NG data pools
...
# ESGF-NG Rook Federation (continued)
...
# ESGF-NG Rook Federation (diagram) {.architecture-diagram}
...
# 1. High-level architecture {.diagram-small}
...
# 2. Local Rook PostgreSQL index (diagram) {.architecture-diagram}
...
# 3. STAC as fallback {.diagram-small}
...
# 4. Broker and orchestrate (diagram) {.architecture-diagram}
...
# 5. From the existing workflow to federation {.diagram-small}
...
# 7. Local execution {.diagram-side}
...
# 8. Remote execution (diagram) {.architecture-diagram}
...
# 9. Asynchronous processing {.diagram-side}
...
# Implementation details (diagram) {.architecture-diagram}
...
# Future improvements (diagram) {.architecture-diagram}
...
# Modernize processing results (diagram) {.architecture-diagram}
...
# Complete proposed solution (continued)
...
# Complete proposed solution (diagram) {.architecture-diagram}
...
# Rook for ESGF-NG (diagram) {.architecture-diagram}
