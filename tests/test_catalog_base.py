...
def test_result_files_uses_project_base_dir(monkeypatch):
    ...
    assert result.files() == {"project.dataset": ["/data/CMIP6/ScenarioMIP/Model/file_201501-210012.nc"]}
...
def test_result_files_uses_global_s3_base_dir(monkeypatch):
    ...
    assert result.files() == {"project.dataset": ["s3://example-bucket/data/CMIP6/ScenarioMIP/Model/file_201501-210012.nc"]}
...
def test_result_files_uses_project_s3_base_dir_override(monkeypatch):
    ...
    assert result.files() == {"project.dataset": ["s3://project-bucket/cmip6/ScenarioMIP/Model/file_201501-210012.nc"]}
...
def test_result_download_urls_keep_data_node_root(monkeypatch):
    ...
    assert result.download_urls() == {"project.dataset": ["https://example.org/thredds/fileServer/cmip6/ScenarioMIP/Model/file_201501-210012.nc"]}
