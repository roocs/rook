...
def test_inventory_get_matches():
    assert(inv.get_matches(['nonsense']) == False)
...
def test_inventory_get_file_paths():
    ...
    expected_file = '/badc/cmip6/data/CMIP6/ScenarioMIP/NCC/NorESM2-LM/ssp245/r1i1p1f1/Amon/' \
...
def test_inventory_get_file_urls():
    ...
    expected_file = f'https://data.mips.copernicus-climate.eu/thredds/fileServer/esg_c3s-cmip6/' \
