from rook.fixes.legacy.utils.fixes_utils import convert_calendar_to_gregorian

from rook.fixes.legacy.utils.attr_utils import (
    edit_global_attrs,
    edit_var_attrs,
)
from rook.fixes.legacy.utils.coord_utils import add_coord, add_scalar_coord
from rook.fixes.legacy.utils.var_utils import add_data_var

model_specific_global_attrs = {
    "CMCC-CM2-SR5": {
        "forcing_description": "f1, CMIP6 historical forcings",
        "physics_description": "physics from the standard model configuration, with no additional tuning or different parametrization",  # ruff: ignore[line-too-long]
...
def decadal_fix_2(ds_id, ds):
    operands = {
        "attrs": {
            ...
            "startdate": "derive: rook.fixes.legacy.utils.decadal_utils.get_sub_experiment_id",
            "sub_experiment_id": "derive: rook.fixes.legacy.utils.decadal_utils.get_sub_experiment_id",
        }
    }
...
def decadal_fix_3(ds_id, ds):
    operands = {
        "var_id": "reftime",
        "value": "derive: rook.fixes.legacy.utils.decadal_utils.get_reftime",
        "dtype": "datetime64[ns]",
        "attrs": {
        ...
        "encoding": {
            ...
            "calendar": "derive: rook.fixes.legacy.utils.decadal_utils.get_time_calendar",
        },
    }
...
def decadal_fix_4(ds_id, ds):
    operands = {
        "var_id": "leadtime",
        "value": "derive: rook.fixes.legacy.utils.decadal_utils.get_lead_times",
        "dim": ["time"],
        "dtype": "float64",
        "attrs": {
